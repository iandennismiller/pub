# -*- coding: utf-8 -*-
#
# pub documentation build configuration file, created by
...
latex_documents = [
    ('index', 'pub.tex', u'pub Documentation',
...
texinfo_documents = [
    ('index', 'pub', u'pub Documentation',
        u'Ian Dennis Miller', 'pub', 'One line description of project.',
        'Miscellaneous'),
]
